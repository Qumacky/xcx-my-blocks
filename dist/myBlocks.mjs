...
var entry = {
  ...
  extensionURL: 'https://Qumacky.github.io/xcx-my-blocks/dist/myBlocks.mjs',
...
var Scratch3NewBlocks = /*#__PURE__*/function () {
  function Scratch3NewBlocks(runtime) {
    classCallCheck(this, Scratch3NewBlocks);

    /**
     * The runtime instantiating this block package.
     * @type {Runtime}
     */
    this.runtime = runtime; //this._onTargetCreated = this._onTargetCreated.bind(this);
